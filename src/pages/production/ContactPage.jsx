...
const ContactPage = () => {
    ...
    return (
        <>
            <Header/>
            <div className="w-full md:w-[85%] flex flex-col gap-20 md:gap-28 mx-auto mb-10 mt-36 md:mt-52">
                <section className="flex flex-col items-center text-center gap-16">
                    ...
                    <div className="flex flex-col items-center gap-6 md:gap-16">
                        <div className="flex flex-col gap-2">
                            ...
                            <address
                                className="not-italic text-white text-lg font-normal md:font-light leading-relaxed">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <Link
                                ...
                                target="_blank"
                                className="text-white text-lg font-light leading-relaxed hover:underline"
                            >
                                hq@boxonia.com
                            </Link>
                        </div>
                        <nav className="flex gap-3 text-3xl">
                            ...
                            <a href="#"><FaLinkedinIn
                                className="text-transparent stroke-white stroke-[30] hover:stroke-yellow-400"/></a>
                            <a href="#"><FaFacebookF
                                className="text-transparent stroke-white stroke-[30] hover:stroke-yellow-400"/></a>
                            <a href="#"><FaYoutube
                                className="text-transparent stroke-white stroke-[30] hover:stroke-yellow-400"/></a>
                ...
                {/*<!----- Contact Page -->*/}
                <section className="space-y-20 text-black">
                    <ArticleHeader title="get in touch"/>
                    {message && <p className="text-green-600">{message}</p>}
                    <form onSubmit={submitForm} className="w-[90%] md:w-3/5 flex mx-auto flex-col gap-6">
                        <div className="flex flex-col gap-1 text-left w-full">
                            <label htmlFor="name"
                                   className="text-gray-400 text-xs md:text-base font-medium">Name:</label>
                            <input
                                type="text"
                                value={formValues.name}
                                className="text-base md:text-lg bg-white w-full rounded-xl px-3 py-4 focus:outline-0"
                        ...
                        <div className="flex flex-col gap-1 text-left w-full">
                            <label htmlFor="email"
                                   className="text-gray-400 text-xs md:text-base font-medium">Email:</label>
                            <input
                        ...
                        <div className="flex flex-col gap-1 text-left w-full">
                            <label htmlFor="subject"
                                   className="text-gray-400 text-xs md:text-base font-medium">Subject:</label>
                            <input
                        ...
                        <div className="flex flex-col gap-1 text-left w-full">
                            <label htmlFor="name" className="text-gray-400 text-xs md:text-base font-medium">Your
                                Message:
                                (optional)</label>
                            <textarea
                                ...
                                rows="3"
                                id="name"
                                className="text-base md:text-lg bg-white w-full rounded-xl px-3 py-4 resize-none focus:outline-0"/>
                        ...
                        <div className="text-center mt-10">
                            <button
                                disabled={loading}
                                type="submit"
                                className={`py-2 px-12 w-fit text-sm md:text-base text-[#989898] border-2 rounded-md disabled:opacity-25 border-[#989898] hover:bg-white hover:text-black`}>
                                send message
                            </button>
                        </div>
                    </form>
