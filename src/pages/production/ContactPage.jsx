                            ...
                            <div className="grid grid-cols-2 gap-6 md:gap-10 w-full">
                                <div className="flex flex-col gap-1 md:gap-2 text-left w-full">
                                    <label htmlFor="firstName"
                                           className="text-[#7F7F7F] text-xs md:text-base font-light">First
                                        Name*</label>
                                    <input
                                        type="text"
                                    ...
                                    {error?.name &&
                                        <span className="text-red-600 text-sm capitalize">{error.name}</span>}
                                </div>
                                <div className="flex flex-col gap-1 md:gap-2 text-left w-full">
                                    <label htmlFor="lastName"
                                           className="text-[#7F7F7F] text-xs md:text-base font-light">Last
                                        Name*</label>
                                    <input
                                        type="text"
