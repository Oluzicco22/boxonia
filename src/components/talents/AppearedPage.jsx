    ...
    return (
        <div className="relative">
            ...
            <div className="bg-transparent md:pb-1 bg-cover bg-center bg-no-repeat min-h-90 md:h-150 relative" style={{
                ...
                <Header/>
                <h1 className="capitalize font-bold text-5xl sm:text-5xl md:text-[150px] absolute -bottom-2 md:-bottom-3 left-1/2 transform -translate-x-1/2 whitespace-nowrap">
            ...
            <Helmet>
                ...
                <meta name="description"
                      content={`Discover ${talent.firstName} ${talent.lastName}'s work and book them through Boxonia Talent Management.`}/>
            </Helmet>
