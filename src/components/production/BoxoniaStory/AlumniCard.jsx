...
const AlumniCard = ({ name, role, info, img }) => {
    ...
    return (
        <article className="flex flex-col sm:grid sm:grid-cols-[200px_1fr] gap-7">
            <div className="flex flex-col items-center justify-start gap-4 text-center text-lg">
            ...
            <div className="flex flex-col items-center gap-6">
                ...
                <button
                    ...
                    className="text-center text-nowrap text-sm border-1 font-normal hover:bg-white hover:text-black border-[#989898] text-[#989898] px-20 py-3 rounded-lg cursor-pointer">{`see ${active ? 'less' : 'more'}`}</button>
            </div>
        </article>
    )
}
