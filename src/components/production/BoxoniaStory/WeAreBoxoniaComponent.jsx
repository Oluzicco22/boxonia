    ...
    return (
        <section className="flex flex-col px-3 md:px-0 w-full text-center mx-auto items-center gap-8">
            <ArticleHeader title="the boxonia story" />
                <div className="w-full flex justify-center text-left md:py-6" style={{
                        backgroundImage: "https://res.cloudinary.com/dybmufexj/image/upload/v1753987268/we-are-boxonia_img_pcmsxm.png",
                }}>
                        <p className="text-[#B7B7B7] leading-8 text-center md:text-left text-lg md:w-9/15">
                                ...
                                African cinema: Boxonia Blueprint. <br/><br/>
                                ...
                                brands like Unilever and British American Tobacco.<br/><br/>
                                ...
                                Boxonia aspires to achieve both cultural impact and commercial success.<br/><br/>
                                ...
                                licensing, and consultancy.<br/><br/>
