                ...
                >
                    {pillars.slice(0, 3).map((pillar, i) => (
                        <div key={i} className="flex flex-col gap-6 md:gap-4 mx-auto w-full">
                            <article className={`flex flex-col justify-center ${i%2 ? "border-[#463103]" : "border-[#525252]"} gap-4 md:gap-3 border-3 min-h-60 md:w-[87%] md:border-none rounded-3xl text-center md:text-left`}>
